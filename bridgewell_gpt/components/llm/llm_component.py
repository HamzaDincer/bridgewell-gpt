...
from bridgewell_gpt.components.llm.prompt_helper import get_prompt_style
from bridgewell_gpt.paths import models_cache_path, models_path
...
class LLMComponent:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        match settings.llm.mode:
            ...
            case "sagemaker":
                try:
                    from bridgewell_gpt.components.llm.custom.sagemaker import SagemakerLLM
                except ImportError as e:
                    raise ImportError(
            ...
            case "ollama":
                ...
                if ollama_settings.autopull_models:
                    from bridgewell_gpt.utils.ollama import check_connection, pull_model
