...
from bridgewell_gpt.settings.settings_loader import load_active_settings
...
class MilvusSettings(BaseModel):
    uri: str = Field(
        "local_data/bridgewell_gpt/milvus/milvus_local.db",
        description="The URI of the Milvus instance. For example: 'local_data/bridgewell_gpt/milvus/milvus_local.db' for Milvus Lite.",
    )
    token: str = Field(
        "",
        description=(
